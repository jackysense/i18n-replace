...
async function setDefaultData(config = {}) {
  ...
  if (config.pluginPrefix !== undefined && config.pluginPrefix)
    globalData.pluginPrefix = config.pluginPrefix;
  ...
  if (config.wordPrefix !== undefined)
    globalData.wordPrefix = config.wordPrefix;
